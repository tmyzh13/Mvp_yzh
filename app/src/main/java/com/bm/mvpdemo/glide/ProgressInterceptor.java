 ...
 * @Description: 描述：加载进度拦截器替换ProgressResponseBody
 * @Author: yizhihao
 * @Date: 2019/6/18 10:22
 */
public class ProgressInterceptor implements Interceptor {

    public static final String TAG = ProgressInterceptor.class.getName();

    private static final Map<String,WeakReference<OnProgressListener>> LISTENER_MAP =Collections.synchronizedMap(new HashMap<String, WeakReference<OnProgressListener>>());
    @Override
    public Response intercept(Chain chain) throws IOException {
        ...
        OnProgressListener progressListener = getProgerssListener(url);
    ...
    private final class OnProgressResponseListener implements ProgressResponseBody.OnResponseListener{
        ...
        public void onStart(String url, long totalBytes) {
            ...
            Log.e("yzh","onStart totalBytes="+totalBytes);
        }
        ...
        public void onRead(String url, long readBytes, long totalBytes) {
            ...
            Log.e("yzh","onRead readbytes="+readBytes+".totalByetes="+totalBytes);
        }
        ...
        public void onDone(String url, long totalBytes) {
            ...
            Log.i(TAG, "onDone totalBytes=" + totalBytes);
        }
    ...
    public static OnProgressListener getProgerssListener(String url){
