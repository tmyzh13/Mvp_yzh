...
import com.bm.mvpdemo.bean.WanBaseData;
...
public class ApiMethod {
     ...
     * @return
     */
    public static Observable<WanBaseData> getObservable1(Observable<WanBaseData> apiObservable, RxFragmentActivity activity){
        Observable observable;
        observable=apiObservable
                //对返回的数据做一次处理，成功--正常返回数据  失败抛出异常
                .map(new ServerResultFunction())
